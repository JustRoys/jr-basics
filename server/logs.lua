...
AddEventHandler("jr-basics:PlayerDied", function(msg, Weapon)
    ...
    if Weapon ~= nil then
        message = msg.." "..Config.Logs.Languages.Weapon.. " ***"..Weapon.."*** "
    else
        message = msg.." "
    end
...
AddEventHandler('playerJoining', function(reason)
    ...
    message = "***"..GetPlayerName(source) .. "*** "..Config.Logs.Languages.Joining.." "..Player_Details
...
AddEventHandler('playerDropped', function(reason)
    ...
    if isdead then
        ...
        Player_Details = GetPlayerDetails(source)
        message = "***"..GetPlayerName(source) .. "*** "..Config.Logs.Languages.Leaving.." "..reason.. "("..Config.Logs.Languages.LeftWhileDead..") \n"..Player_Details
        ...
        Player_Details = GetPlayerDetails(source)
        message = "***"..GetPlayerName(source) .. "*** "..Config.Logs.Languages.Leaving.." "..reason.. " \n"..Player_Details
...
function GetPlayerDetails(source)
    ...
    if GetConvar("steam_webApiKey", "false") ~= 'false' then
        ...
        _steamID = ""
        _steamURL = ""
        print(Config.Logs.Languages.ApiKey)
    end
